...
def import_data():
    ...
    appointments = [
        ...
        ("جمال مخطار", "عامل على عمالة مقاطعات مولاي رشيد بالدار البيضاء", "ترابية", "جهة الدار البيضاء سطات", "عمالة الدار البيضاء","عمالة مقاطعات مولاي رشيد", "2018-08-20", 2018),
